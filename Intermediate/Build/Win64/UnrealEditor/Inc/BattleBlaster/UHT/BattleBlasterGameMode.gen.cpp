...
#if !UE_BUILD_SHIPPING
		{ "Comment", "// this will be called when tank or towers health become zero and we need to certain things to it\n" },
#endif
		{ "ModuleRelativePath", "BattleBlasterGameMode.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "this will be called when tank or towers health become zero and we need to certain things to it" },
#endif
	};
#endif // WITH_METADATA
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameMode_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABattleBlasterGameMode, ABattleBlasterGameMode::StaticClass, TEXT("ABattleBlasterGameMode"), &Z_Registration_Info_UClass_ABattleBlasterGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABattleBlasterGameMode), 3842922251U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameMode_h__Script_BattleBlaster_3026881313(TEXT("/Script/BattleBlaster"),
	Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameMode_h__Script_BattleBlaster_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameMode_h__Script_BattleBlaster_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
