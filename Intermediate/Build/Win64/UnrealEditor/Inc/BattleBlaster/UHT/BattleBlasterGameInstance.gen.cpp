...
struct Z_Construct_UClass_UBattleBlasterGameInstance_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CurrentLevelIndex_MetaData[] = {
		{ "Category", "BattleBlasterGameInstance" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// total number of levels\n" },
#endif
		{ "ModuleRelativePath", "BattleBlasterGameInstance.h" },
#if !UE_BUILD_SHIPPING
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBattleBlasterGameInstance_Statics::NewProp_CurrentLevelIndex = { "CurrentLevelIndex", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBattleBlasterGameInstance, CurrentLevelIndex), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CurrentLevelIndex_MetaData), NewProp_CurrentLevelIndex_MetaData) };
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameInstance_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBattleBlasterGameInstance, UBattleBlasterGameInstance::StaticClass, TEXT("UBattleBlasterGameInstance"), &Z_Registration_Info_UClass_UBattleBlasterGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBattleBlasterGameInstance), 2596105664U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameInstance_h__Script_BattleBlaster_3026397948(TEXT("/Script/BattleBlaster"),
	Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameInstance_h__Script_BattleBlaster_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_BattleBlasterGameInstance_h__Script_BattleBlaster_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
