...
struct Z_Construct_UClass_ATower_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FiringRange_MetaData[] = {
		{ "Category", "Tower" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// the tower is going to use this pointer in order to rotate towards the tank\n" },
#endif
		{ "ModuleRelativePath", "Tower.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "the tower is going to use this pointer in order to rotate towards the tank" },
#endif
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ATower_Statics::NewProp_FiringRange = { "FiringRange", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ATower, FiringRange), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FiringRange_MetaData), NewProp_FiringRange_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATower_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATower_Statics::NewProp_FiringRange,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_Tower_h__Script_BattleBlaster_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATower, ATower::StaticClass, TEXT("ATower"), &Z_Registration_Info_UClass_ATower, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATower), 587252357U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_Tower_h__Script_BattleBlaster_1814310123(TEXT("/Script/BattleBlaster"),
	Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_Tower_h__Script_BattleBlaster_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Game_BattleBlaster_Source_BattleBlaster_Tower_h__Script_BattleBlaster_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
